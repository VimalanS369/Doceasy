...
public class AppointmentService {
	...
	public void placeAppointment(AppointmentRequest appointmentRequest) {
	    ...
	    //Call Availability Service, and place order if Appointment is available
	    //in Availability Ms
	   ...
	   //Returns true if All the appointments Booked Are In stock
